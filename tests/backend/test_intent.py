...
def test_multiple_markers_merge_into_one_scheduling_envelope():
    ...
    handoff."""
    raw = """Draft.
<!-- hermes-crew:intent {"schemaVersion":1,"intent":"review_request","recipients":["critic"],"replyExpected":true,"replyBudget":2} -->
Final.
<!-- hermes-crew:intent {"schemaVersion":1,"intent":"handoff","recipients":["atlas"],"replyExpected":true,"replyBudget":1,"placement":"thread"} -->
...
def test_bracket_marker_form_parses_and_strips():
    ...
    raw = (
        'Handing off.\n'
        '[[hermes-crew:intent {"schemaVersion":1,"intent":"handoff",'
