...
RESPONSE_CONTRACT = """End your final response with exactly one Markdown-hidden comment and no text after it:
...
class ContextBuilder:
    ...
    def for_turn(self, turn: PlannedTurn) -> str:
        ...
        automated_count = sum(1 for item in thread if item.author_type == "agent")
